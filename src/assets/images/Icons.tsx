...
export function displayIcon(iconType: enumIconTypes, iconName: iconsType, iconSize: number, iconColor: string, style?: StyleProp<TextStyle>, onPressFunction?: ((event: GestureResponderEvent) => void) | undefined) {
    ...
    switch (iconType) {
        case enumIconTypes.materialCommunity:
            return <MaterialCommunityIcons name={iconName as materialCommunityIconName} size={iconSize}
                                           color={iconColor} style={propStyle} onPress={onPressFunction}/>;
        case enumIconTypes.fontAwesome:
            return <FontAwesome name={iconName as fontAwesomeIconName} size={iconSize} color={iconColor}
                                style={propStyle} onPress={onPressFunction}/>;
        case enumIconTypes.entypo:
            return <Entypo name={iconName as entypoIconName} size={iconSize} color={iconColor} style={propStyle}
