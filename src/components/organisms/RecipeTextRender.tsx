...
export type RecipeTextRenderReadOnlyOrAddOrEdit =
  ...
  return (
    <View style={recipeTextRenderStyles.containerSection}>
      {textRenderProps.type === 'readOnly' ? (
        <TextRender
          testID={textRenderProps.testID + '::TextRender'}
          text={textRenderProps.text}
        ...
        <View>
          {textRenderProps.prefixText ? (
            <Text
              testID={textRenderProps.testID + '::PrefixText'}
          ...
          {textRenderProps.editType === 'editable' ? (
            <View>
              ...
              <RoundButton
                testID={`${textRenderProps.testID}::AddButton`}
                size={'medium'}
                icon={Icons.plusIcon}
            ...
            <View style={recipeTextRenderStyles.roundButtonPadding}>
              <RoundButton
                testID={`${textRenderProps.testID}::OpenModal`}
                size={'medium'}
