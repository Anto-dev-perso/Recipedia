...
import {cropData, Layout} from '@customTypes/ImageTypes';
            ...
            <GestureHandlerRootView style={{flex: 1}}>
                <PanGestureHandler onGestureEvent={onOverlayMove} onHandlerStateChange={(e) => onHandlerStateChange(e)}>
                    <Animated.View
                        ...
                        }, animatedCropSize, {transform: [{translateX: Animated.add(panX.current, accumulatedPan.x)}, {translateY: Animated.add(panY.current, accumulatedPan.y)}]}]}>
                                        ...
                                        return (
                                            <View style={[styles.defaultSection, {
                                                ...
                                                {key === 'topleft' || key === 'topright' || key === 'bottomleft' || key === 'bottomright' ?
                                                    coverMarker?.show && (
                                                        <View
                                                            style={[styles.cornerMarker, {borderColor: coverMarker?.color},
