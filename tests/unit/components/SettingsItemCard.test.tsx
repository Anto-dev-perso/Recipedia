...
describe('SettingsItemCard Component', () => {
    ...
    describe('ingredient', () => {
        ...
        test('renders without crashing', () => {
            ...
            expect(getByTestId(`${testIDProp}::0::SeasonalityCalendar::SelectedMonths`).props.children).toEqual(JSON.stringify(defaultProps.item.season));
            expect(getByTestId(`${testIDProp}::0::SeasonalityCalendar::ReadOnly`).props.children).toEqual(true);
