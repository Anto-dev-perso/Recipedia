        ...
        const mockIngredientHelloFresh: TextRecognitionResult = {
            ...
            blocks: new Array<TextBlock>(
                ...
                },
                {
                    ...
                    text: "",
                    lines: new Array<TextLine>({
                        elements: [], recognizedLanguages: [], text: "Ciboulette"
                    })
                },
                {
                    recognizedLanguages: [],
                ...
                },
                {
                    ...
                    text: "",
                    lines: new Array<TextLine>({
                        elements: [], recognizedLanguages: [], text: "Huile de sésame 3)"
                    })
                },
                {
                    recognizedLanguages: [],
                ...
                },
                {
                    ...
                    text: "",
                    lines: new Array<TextLine>({
                        elements: [], recognizedLanguages: [], text: "140 g"
                    })
                },
                {
                    recognizedLanguages: [],
                ...
                },
                {
                    ...
                    text: "",
                    lines: new Array<TextLine>({
                        elements: [], recognizedLanguages: [], text: "1 pièce"
                    })
                },
                {
                    recognizedLanguages: [],
                ...
                },
                {
                    ...
                    text: "",
                    lines: new Array<TextLine>({
                        elements: [], recognizedLanguages: [], text: "2 cm"
                    })
                },
                {
                    recognizedLanguages: [],
                ...
                },
                {
                    ...
                    text: "",
                    lines: new Array<TextLine>({
                        elements: [], recognizedLanguages: [], text: "2 pièce"
                    })
                },
                {
                    recognizedLanguages: [],
                ...
                const expected = new Array<ingredientObject>(
                    {
                        ...
                        quantityPerPersons: new Array<ingredientQuantityPerPersons>({persons: 2, quantity: "1"}, {
                            persons: 3,
                            quantity: "2"
                        }, {persons: 4, quantity: "2"}, {persons: 5, quantity: "3"}),
                    },
                    {
                        name: "citronnelle",
                        unit: "",
                    ...
                    },
                    {
                        ...
                        quantityPerPersons: new Array<ingredientQuantityPerPersons>({persons: 2, quantity: "100"}, {
                            persons: 3,
                            quantity: "150"
                        }, {persons: 4, quantity: "200"}, {persons: 5, quantity: "265"}),
                    },
                    {
                        name: "purée de tomates",
                        unit: "g",
                        quantityPerPersons: new Array<ingredientQuantityPerPersons>({persons: 2, quantity: "125"}, {
                            persons: 3,
                            quantity: "125"
                        }, {persons: 4, quantity: "250"}, {persons: 5, quantity: "250"}),
                    },
                    {
                        name: "riz basmati  Bio",
                        unit: "g",
                ...
                const expected = new Array<ingredientObject>(
                    ...
                    },
                    {
                        ...
                        quantityPerPersons: new Array<ingredientQuantityPerPersons>({
                            persons: 2,
                            quantity: "1"
                        }, {persons: 4, quantity: "2"}, {persons: 5, quantity: "6"}),
                    },
                );
                ...
                const expected = new Array<ingredientObject>(
                    {
                        name: "Riz basmati",
                        unit: "g",
                        quantityPerPersons: new Array<ingredientQuantityPerPersons>({persons: -1, quantity: "140"}),
                    },
                    {
                        name: "Oignon jaune",
                        unit: "pièce",
                        quantityPerPersons: new Array<ingredientQuantityPerPersons>({persons: -1, quantity: "1"}),
                    },
                    {
                        name: "Carotte\"",
                        unit: "pièce",
                    ...
                    },
                    {
                        name: "Ciboulette",
                        unit: "",
                        quantityPerPersons: new Array<ingredientQuantityPerPersons>({persons: -1, quantity: "3g"}),
                    },
                    {
                        name: "Gousse d'ail",
                        unit: "pièce",
                    ...
                    },
                    {
                        ...
                        unit: "cm",
                        quantityPerPersons: new Array<ingredientQuantityPerPersons>({persons: -1, quantity: "2"}),
                    },
                    {
                        name: "Sauce soja 11) 13) 15)",
                        unit: "ml",
                        quantityPerPersons: new Array<ingredientQuantityPerPersons>({persons: -1, quantity: "40"}),
                    },
                    {
                        name: "Huile de sésame 3)",
                        unit: "ml",
                        quantityPerPersons: new Array<ingredientQuantityPerPersons>({persons: -1, quantity: "10"}),
                    },
                    {
                        name: "Filet de poulet",
                        unit: "pièce",
    ...
    describe('on tags field', () => {
        ...
        describe('on extractFieldFromImage', () => {
            test('returns the correct value', async () => {
                ...
                expect(result).toEqual({recipeTags: new Array<tagTableElement>(tagAlreadyPresent, ...expectedTags)});
            });
        });
